...
function AudioFrame(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    } : require('../../internal/resources/transparent_200x300.png'),
    resizeMode: "cover",
  ...
  }, getShortName(userInfo.userName)) : /*#__PURE__*/_react.default.createElement(_reactNative.Image, {
    style: {
      width: '100%',
      height: '100%',
      resizeMode: 'contain'
    ...
    onLoadStart: () => (0, _logger.zloginfo)('avatar onLoadStart'),
    onLoadEnd: () => (0, _logger.zloginfo)('avatar onLoadEnd'),
    onError: () => {
      (0, _logger.zloginfo)('avatar onError');
      setIsLoadError(true);
    },
    onLoad: () => {
      (0, _logger.zloginfo)('avatar onLoad');
    ...
    style: styles.nameLabel
  }, getShortName(userInfo.userName)) : null, /*#__PURE__*/_react.default.createElement(_reactDelegateComponent.default, {
    to: avatarBuilder,
    props: {
      userInfo: userInfo
    }
