...
function MoreFrame(props) {
  ...
  }, getShortName(userList[0].userName))), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: [styles.avatar, styles.avatar2]
  }, /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    style: styles.nameLabel
  }, getShortName(userList[1].userName)))), /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
