import { type ZIMAppConfig, type ZIMUserInfo, type ZIMCallInviteConfig, type ZIMCallCancelConfig, type ZIMCallAcceptConfig, type ZIMCallRejectConfig, type ZIMCallInvitationQueryConfig, type ZIMCallInfo, ZIMConnectionState } from 'zego-zim-react-native';
export default class ZegoSignalingPluginCore {
    ...
    _callIDExtendedData: Map<string, string>;
    ...
    _onRequireNewTokenCallbackMap: {
        [index: string]: () => string;
    };
    _onLoginSuccessCallbackMap: {
        [index: string]: () => void;
    };
    constructor();
    ...
    _getExtendedDataByCallID(callID: string): string;
    _createHandle(): void;
    ...
    logout(): Promise<void>;
    destroy(): void;
    setAdvancedConfig(key: string, value: string): void;
    ...
    onRequireNewToken(callbackID: string, callback: () => string): void;
