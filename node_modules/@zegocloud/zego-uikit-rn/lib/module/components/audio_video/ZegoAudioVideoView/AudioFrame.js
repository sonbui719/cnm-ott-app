...
export default function AudioFrame(props) {
  ...
  useEffect(() => {
    ...
    ZegoUIKitInternal.onSoundLevelUpdate(callbackID, (userID, soundLevel) => {
  ...
  return /*#__PURE__*/React.createElement(View, {
  ...
  }, !avatarBuilder ? !avatar || isLoadError ? /*#__PURE__*/React.createElement(Text, {
    style: styles.nameLabel
  }, getShortName(userInfo.userName)) : /*#__PURE__*/React.createElement(Image, {
    style: {
      width: '100%',
      height: '100%',
      resizeMode: 'contain'
    ...
    onError: () => {
      zloginfo('avatar onError');
      setIsLoadError(true);
    },
    onLoad: () => {
      zloginfo('avatar onLoad');
    ...
    style: styles.nameLabel
  }, getShortName(userInfo.userName)) : null, /*#__PURE__*/React.createElement(Delegate, {
    to: avatarBuilder,
    props: {
      userInfo: userInfo
    }
