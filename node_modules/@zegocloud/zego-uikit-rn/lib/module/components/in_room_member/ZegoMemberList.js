...
export default function ZegoMemberList(props) {
  ...
  const renderItem = ({
    item
  }) => !itemBuilder ? /*#__PURE__*/React.createElement(View, {
    style: styles.item
  }, /*#__PURE__*/React.createElement(View, {
    style: styles.itemLeft
  }, /*#__PURE__*/React.createElement(View, {
    style: styles.avatar
  }, avatarBuilder ? /*#__PURE__*/React.createElement(Delegate, {
    to: avatarBuilder,
    props: {
      userInfo: item
    }
  ...
  }, getShortName(item.userName))), /*#__PURE__*/React.createElement(Text, {
    style: styles.name
  ...
  useEffect(() => {
    ...
    ZegoUIKitInternal.onUserCountOrPropertyChanged(callbackID, userList => {
      zloginfo('===============onUserCountOrPropertyChanged==============', userList);
      if (typeof sortUserList === 'function') {
