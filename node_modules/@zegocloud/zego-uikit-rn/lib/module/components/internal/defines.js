...
import { ZegoOrientation, ZegoVideoConfig } from 'zego-express-engine-reactnative';
...
class ZegoUIKitVideoConfig {
  constructor(fps, bitrate, width, height) {
...
export { ZegoAudioVideoResourceMode, ZegoChangedCountOrProperty, ZegoUIKitPluginType, ZegoRoomPropertyUpdateType, ZegoUIKitVideoConfig, ZegoToastType };
