import { CXAction } from '@zegocloud/zego-uikit-rn';
...
export default class NotificationHelper {
    ...
    _onCallKitEndCall(action: CXAction): void;
    _refuse(action: CXAction, callID: string, roomID: string, inviter: any, reason: string, appState: string): void;
    _onCallKitAnswerCall(action: CXAction): void;
