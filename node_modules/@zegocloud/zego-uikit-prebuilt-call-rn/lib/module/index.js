...
import { ONE_ON_ONE_VIDEO_CALL_CONFIG, ONE_ON_ONE_VOICE_CALL_CONFIG, GROUP_VIDEO_CALL_CONFIG, GROUP_VOICE_CALL_CONFIG, ZegoMultiCertificate, ZegoCallEndReason } from './services/defines';
export default ZegoUIKitPrebuiltCallService.getInstance();
export { ZegoUIKitPrebuiltCall, ZegoUIKitPrebuiltCallFloatingMinimizedView, ZegoSendCallInvitationButton, ZegoCallInvitationDialog, ZegoUIKitPrebuiltCallWaitingScreen, ZegoUIKitPrebuiltCallInCallScreen, ZegoCountdownLabel, ZegoMenuBarButtonName, ZegoMenuBarStyle, ONE_ON_ONE_VIDEO_CALL_CONFIG, ONE_ON_ONE_VOICE_CALL_CONFIG, GROUP_VIDEO_CALL_CONFIG, GROUP_VOICE_CALL_CONFIG, ZegoInvitationType, ZegoMultiCertificate, ZegoCallEndReason };
