...
const CallInviteStateManage = {
  ...
  _notifyInviteCompletedWithNobody: callID => {
    ...
    if (stateDetails) {
      zloginfo('######_notifyInviteCompletedWithNobody######', callID, CallInviteStateManage._invitationMap);
  ...
  registerCallback: () => {
    ...
    ZegoUIKit.getSignalingPlugin().onInvitationResponseTimeout(CallInviteStateManage._callbackID, ({
      callID,
      invitees,
      data
    }) => {
    ...
    ZegoUIKit.getSignalingPlugin().onInvitationRefused(CallInviteStateManage._callbackID, ({
      callID,
      invitee,
      data
    }) => {
    ...
    ZegoUIKit.getSignalingPlugin().onInvitationAccepted(CallInviteStateManage._callbackID, ({
      callID,
      invitee,
      data
    }) => {
      // update _invitationMap
      zloginfo('######onInvitationAccepted######', CallInviteStateManage._invitationMap, callID);
      const inviteDetails = CallInviteStateManage._invitationMap.get(callID);
      if (inviteDetails) {
    ...
    ZegoUIKit.getSignalingPlugin().onInvitationCanceled(CallInviteStateManage._callbackID, ({
      callID,
      inviter,
      data
    }) => {
    ...
    ZegoUIKit.getSignalingPlugin().onInvitationTimeout(CallInviteStateManage._callbackID, ({
      callID,
      inviter,
      data
    }) => {
  ...
  isAutoCancelInvite: invitationID => {
    zloginfo('######isAutoCancelInvite######', invitationID, CallInviteStateManage._invitationMap);
    let auto = false;
