...
export default function ZegoSendCallInvitationButton(props) {
  ...
  const onPress = ({
    ...
    ZegoUIKitPrebuiltCallInvitation.getInstance().onInvitationSent(navigation, invitationID, invitees, successfulInvitees, _roomID, isVideoCall, callName, showWaitingPageWhenGroupCall);
  ...
  return /*#__PURE__*/React.createElement(View, {
  ...
  }, /*#__PURE__*/React.createElement(ZegoSendInvitationButton, {
    icon: icon,
    text: text,
    ...
    notificationTitle: callName ? callName : InnerTextHelper.instance().getIncomingCallDialogTitle(localUser.userName, isVideoCall ? ZegoInvitationType.videoCall : ZegoInvitationType.voiceCall, invitees.length),
    notificationMessage: InnerTextHelper.instance().getIncomingCallDialogMessage(isVideoCall ? ZegoInvitationType.videoCall : ZegoInvitationType.voiceCall, invitees.length)
  }));
}
const styles = StyleSheet.create({
  container: {}
});
//# sourceMappingURL=ZegoSendCallInvitationButton.js.map