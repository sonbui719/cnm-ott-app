...
import ZegoUIKit, { ZegoAudioVideoContainer, ZegoInRoomMessageInput, ZegoInRoomMessageView, ZegoLayoutMode, ZegoToast, ZegoToastType } from '@zegocloud/zego-uikit-rn';
...
function ZegoUIKitPrebuiltCall(props, ref) {
  ...
  const resetToastInvisableTimeout = useCallback((duration = 3000) => {
  ...
  const showToast = useCallback(({
    ...
    resetToastInvisableTimeout(duration);
  ...
  useEffect(() => {
    ...
    eventEmitter.on(EventName.SHOW_TOAST, showToast);
    ...
    zloginfo(`[ZegoUIKitPrebuiltCall] KeepAwake activate`);
    activateKeepAwake();
    ...
    return () => {
      ...
      eventEmitter.off(EventName.SHOW_TOAST, showToast);
      clearTimeout(toastInvisableTimeoutRef.current);
      backHandler.remove();
      navigation.setOptions({
        gestureEnabled: true
  ...
  return /*#__PURE__*/React.createElement(View, {
    ...
    pointerEvents: "none"
  }, /*#__PURE__*/React.createElement(ZegoPrebuiltForegroundView, {
  ...
  , {
    ...
    foregroundBuilder: foregroundBuilder ? foregroundBuilder : ({
      userInfo
    }) => /*#__PURE__*/React.createElement(AudioVideoForegroundView, {
      userInfo: userInfo,
  ...
  }), showMessageListView() ? /*#__PURE__*/React.createElement(View, {
    style: styles.messageListView
  }, /*#__PURE__*/React.createElement(ZegoInRoomMessageView, {
    itemBuilder: messageItemBuilder,
    style: styles.fillParent
  })) : null), isBottomMenubarVisable ? /*#__PURE__*/React.createElement(ZegoBottomBar, {
  ...
  }) : /*#__PURE__*/React.createElement(View, null), textInputVisable ? /*#__PURE__*/React.createElement(KeyboardAvoidingView, {
    style: styles.fillParent,
...
export default /*#__PURE__*/forwardRef(ZegoUIKitPrebuiltCall);
