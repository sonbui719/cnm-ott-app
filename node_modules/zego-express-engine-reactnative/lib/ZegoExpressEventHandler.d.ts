...
export interface ZegoEventListener {
   ...
   */
  videoObjectSegmentationStateChanged: (
    state: zego.ZegoObjectSegmentationState,
    channel: zego.ZegoPublishChannel,
    errorCode: number
  ) => void
  /**
  ...
  capturedDataRecordStateUpdate: (
    state: zego.ZegoDataRecordState,
    errorCode: number,
  ...
  capturedDataRecordProgressUpdate: (
    progress: zego.ZegoDataRecordProgress,
    config: zego.ZegoDataRecordConfig,
    channel: zego.ZegoPublishChannel
  ) => void
  /**
  ...
  networkSpeedTestQualityUpdate: (
    quality: zego.ZegoNetworkSpeedTestQuality,
    type: zego.ZegoNetworkSpeedTestType
  ) => void
  /**
  ...
  networkQuality: (
    userID: string,
    upstreamQuality: zego.ZegoStreamQualityLevel,
    downstreamQuality: zego.ZegoStreamQualityLevel
  ) => void
  /**
...
export interface ZegoRealTimeSequentialDataEventHandler {
  /**
...
export interface ZegoMediaPlayerListener {
  ...
  mediaPlayerStateUpdate: (
    mediaPlayer: zego.ZegoMediaPlayer,
    state: zego.ZegoMediaPlayerState,
    errorCode: number
  ) => void
  /**
  ...
  mediaPlayerNetworkEvent: (
    mediaPlayer: zego.ZegoMediaPlayer,
    networkEvent: zego.ZegoMediaPlayerNetworkEvent
  ) => void
  /**
   ...
   * @param data SEI content.
   */
  mediaPlayerRecvSEI: (mediaPlayer: zego.ZegoMediaPlayer, data: Uint8Array) => void
  /**
   ...
   */
  mediaPlayerSoundLevelUpdate: (mediaPlayer: zego.ZegoMediaPlayer, soundLevel: number) => void
  /**
  ...
  mediaPlayerFirstFrameEvent: (
    mediaPlayer: zego.ZegoMediaPlayer,
    event: zego.ZegoMediaPlayerFirstFrameEvent
  ) => void
  /**
...
export interface ZegoAudioEffectPlayerListener {
   ...
   * @param errorCode Error code, please refer to the error codes document https://docs.zegocloud.com/en/5548.html for details.
   */
  audioEffectPlayerStateUpdate: (
    audioEffectPlayer: zego.ZegoAudioEffectPlayer,
    audioEffectID: number,
    state: zego.ZegoAudioEffectPlayState,
    errorCode: number
  ) => void
}
export interface ZegoCopyrightedMusicListener {
  /**
  ...
  downloadProgressUpdate: (
    copyrightedMusic: zego.ZegoCopyrightedMusic,
    resourceID: string,
    progressRate: number
  ) => void
  /**
