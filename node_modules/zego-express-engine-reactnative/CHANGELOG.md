...
1. Add the callback of engine state update.
2. Update native sdk version to 3.22.0

## 3.20.2

1. Add the real-time sequential data feature.
2. Update native sdk version to 3.20.2

## 3.19.3

1. Fix the issue that the resource mode of the playing stream does not take effect.

## 3.19.0.43419

1. Update native sdk version to 3.19.0.43419
2. Add CopyrightedMusic module.
3. Add some new APIs in the media player module.

## 3.19.2

1. Support for new architecture and compatible old architecture.

## 3.19.1

1. Adapt the New Architecture uses Turbo Native Module and Fabric Native Components
