...
import {
  ...
  TouchableOpacity,
  View,
  Linking, // 1. Thêm thư viện này để mở trình duyệt
} from "react-native";
...
export default function LoginScreen() {
  ...
  // 2. Hàm xử lý khi bấm nút GitHub
  const handleGitHubLogin = () => {
    // Địa chỉ IP máy tính Kiên vừa tìm thấy (192.168.1.28)
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>StartupChat</Text>
          <Text style={styles.subtitle}>OTT cho Nhóm Khởi Nghiệp</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.socialRow}>
            ...
            {/* 3. Nút GitHub đã được gắn sự kiện onPress */}
            <TouchableOpacity 
          ...
          >
            ...
            <Text style={styles.demoInfo}>admin@startup.com / 123456</Text>
          </TouchableOpacity>
